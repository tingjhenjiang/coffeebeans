...
overall_workingdir = commonsettings.privateSettings['baseworkingdir']
...
overall_traindataSrcPathBaseDisplayed = commonsettings.privateSettings['traindataSrcPathBase']
...
clsModelSourceFile = commonsettings.privateSettings['clsModel']
            ...
            for rectangle_key,rectanglePredResult in enumerate(rectanglePredResults):
                toAppendRectangleDict = {
                    ...
                    'value': {
                        ...
                        'rotation': 0,
                        'rectanglelabels': [rectanglePredResult['label']],
